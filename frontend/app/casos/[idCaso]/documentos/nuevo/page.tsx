...
import FormularioNuevoDocumento from "../../../../../components/casos/FormularioNuevoDocumento";
    ...
    <MarcoAplicacion activeSection="Casos">
      <section className="h-full min-h-0 overflow-y-auto bg-[#F4F7F5] text-[#0F2044]">
        ...
        <main className="px-9 py-9">
          <section className="mb-[50px] flex h-[90px] w-[340px] items-center gap-2 rounded-[23px] border-2 border-[#88A9C8] bg-white px-5 text-[28px] leading-none">
            <DocumentIcon className="h-9 w-9" />
            Agregar documentos
          </section>

          <FormularioNuevoDocumento caseId={idCaso} />
        </main>
      </section>
    </MarcoAplicacion>
  );
