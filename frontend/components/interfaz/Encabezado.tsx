  ...
  return (
    <header className="flex h-[64px] shrink-0 items-center justify-between border-b border-[#84A2BD]/35 bg-white/95 px-6 shadow-[0_1px_12px_rgba(15,32,68,0.06)]">
      ...
      <nav className="flex items-center gap-3 text-sm font-medium">
        <Link
          aria-label="Ajustes"
          className="grid h-10 w-10 place-items-center rounded-full text-[#0F2044] transition hover:bg-[#84A2BD]/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#546FC0]/30"
          href="/configuracion"
        >
          <svg
            aria-hidden="true"
